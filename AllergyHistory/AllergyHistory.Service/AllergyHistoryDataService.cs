...
namespace AllergyHistory.Services
{
    public class AllergyHistoryDataService : IAllergyHistoryDataService
    {
        ...
        public IEnumerable<AllergyHistoryDataTableViewModel> GetAllDataWithClientQuery(string query)
        {
            /// Fake data here
            
            var data = new List<AllergyHistoryDataTableViewModel>();

            var originFakeData = new AllergyHistoryDataTableViewModel();
            ...
            for(int i = 0; i < 10; i++)
            {
                ...
                var temp = new AllergyHistoryDataTableViewModel();
